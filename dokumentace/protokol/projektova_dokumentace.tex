...
\usepackage{graphicx}
\usepackage{placeins}     % \FloatBarrier — drží figure/table před daným místem
\usepackage{booktabs}
\usepackage{array}
\usepackage{tabularx}
...
\begin{thebibliography}{9}
  ...
  \bibitem{gemini}
  Google. \textit{Gemini} (jazykový model, generování loga a~videa Gemini Veo). Dostupné z:\\
  \url{https://gemini.google.com}

  \bibitem{notebooklm}
  Google. \textit{NotebookLM} (zpracování briefu, přepis konzultace). Dostupné z:\\
